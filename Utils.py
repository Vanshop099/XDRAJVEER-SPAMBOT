RAID = [
    ...
    " TERII MAIYA KO @XD_RAJVEER @Bhagwaan_5301 and @SHERBAAP K LAVDE PE BAITHAAA K GYM KARWAUNGA MADARXHODDD RAAAND"
    "TERE 2 BAAP K NAAAAAM  @XD_RAJVEER @SHERBAAP @Bhagwaan_5301 @"
    ...
    "TERIIII MAIYA K @XD_RAJVEER @SHERBAAP @nouseridfoundBHAGWAAN_5301 AND @NOUSERIDFOUND SAIYA HAI RANDIII AURAT K LADKE"
    ...
    "TERA PEHLA BAAP HU @XD_RAJVEER @SHERBAAP @bhagwaan_5301 @nouseridfound MADARCHOD ",
    ...
    "MADRCHOD..TERA BAAP @XD_RAJVEER @SHERBAAP @BHAGWAAN_5301 @NOUSERIDFOUND",
    "TERI MA KI CHUT..",
    "LWDE KE BAAALLL.",
  ...
  "KIDSSSS",
    ...
    "TERAA BAAAAP HU @XD_RAJVEER @SHERBAAP  @bhagwaan_5301 @nouseridfound @godlag ",
    ...
    "Teri maa RANDI HAI OR RAKHEL H @XD_RAJVEER @SHERBAAP @BHAGWAAN_5301 @NOUSERIDFOUND KI😂",
    ...
    "TERI MAA KAA BHOSDA MEE BROWN SUGAR DAL KE CHATEGA @XD_RAJVEER @SHERBAAP @bhagwaan_5301 @nouseridfound",
]
...
RRAID = [
    ...
    "T3RI MAA KA BHOSDA @XD_RAJVEER @SHERBAAP @bhagwaan_5301 @nouseridfound FAAD DEGA FIR SAB LOOTNE AA JAYENGE\n🍌🤤🍌🤤🍌🤤🍌🤤🍌",
    ...
    "TERI MAA KA YAAR HU MEI AUR TERI BAHEN KA PYAAR HU MEI AJA MERA LAND CHOOS LE 🤩🤣💥",
    "TERI MAA KAA BHOSDA MEE BROWN SUGAR DAL KE CHATEGA @XD_RAJVEER @SHERBAAP @bhagwaan_5301 @nouseridfound",
    "TERI MA KE BHOSDE ME CHAMKADARXHUSA DUNGA CHAMKADAR TERI MAIYA KI CHUT SE OANNI NIKALEGA TAPATAP 😆😆 TERI RNDI MAIYA MARGYI OHH CHUT KE CHINNAL ]
